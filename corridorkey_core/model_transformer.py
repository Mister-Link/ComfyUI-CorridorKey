# GreenFormer model definition, vendored unmodified from
# https://huggingface.co/spaces/Luminia/CorridorKey (CorridorKeyModule/core/model_transformer.py).
# Original architecture: CorridorKey by Niko Pueringer / Corridor Digital
